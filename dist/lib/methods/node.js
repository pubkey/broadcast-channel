...
function _createSocketEventEmitter() {
  _createSocketEventEmitter = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee1(channelName, readerUuid, paths) {
        ...
        case 0:
          ...
          return new Promise(function (resolve, reject) {
            ...
            server.listen(pathToSocket, /*#__PURE__*/function () {
              var _ref6 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee0(err, res) {
                var useErr;
...
function _openClientConnection() {
  _openClientConnection = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee10(channelName, readerUuid) {
 ...
 * @return {string[]}
 */
function getReadersUuids(_x0, _x1) {
  return _getReadersUuids.apply(this, arguments);
}
function _getReadersUuids() {
  _getReadersUuids = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee11(channelName, paths) {
...
function _messagePath() {
  _messagePath = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee12(channelName, time, token, writerUuid) {
    var fileName;
    return _regenerator["default"].wrap(function (_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          fileName = time + '_' + writerUuid + '_' + token + '.json';
          return _context12.abrupt("return", _path["default"].join(getPaths(channelName).messages, fileName));
        case 1:
        case "end":
...
function _getAllMessages() {
  _getAllMessages = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee13(channelName, paths) {
...
function _cleanOldMessages() {
  _cleanOldMessages = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee14(messageObjects, ttl) {
    var olderThan;
...
function _create() {
  _create = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee15(channelName) {
    var options,
      time,
      paths,
...
function _handleMessagePing() {
  _handleMessagePing = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee16(state, msgObj) {
 ...
 * @return {Promise<void>}
 */
function postMessage(_x23, _x24) {
...
function _postMessage() {
  _postMessage = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee18(channelState, messageJson) {
    var writePromise;
    return _regenerator["default"].wrap(function (_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        case 0:
          ...
          channelState.writeBlockPromise = channelState.writeBlockPromise.then(/*#__PURE__*/(0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee17() {
